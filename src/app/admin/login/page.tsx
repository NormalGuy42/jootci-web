        ...
        <div>
            ...
            <div className="pt-32">
                <form action="" className="w-[380px] shadow-md mx-auto border rounded border-gray-400 pb-8">
                    <h2 className="sub-title text-center py-8">Bienvenue Admin</h2>
                    <div className="flex flex-col pt-2 items-center">
                        <div className="flex flex-col pb-4">
                            <label htmlFor="#email">Identifiant</label>
                            <input type="text" placeholder="Entrez votre identifiant" id="email" className="p-3 border border-gray-400 w-[280px]"/>
                        ...
                        <button className="secondary-btn w-[280px] py-2" type="button" onClick={()=>window.location.href="/admin"}>Connectez vous</button>
                    </div>
                </form>
            </div>
        </div>
